                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', flex: 1, gap: '4px' }}>
                    <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                      <input
                        ...
                        onKeyDown={e => { if (e.key === 'Enter') saveEdit(p.name); if (e.key === 'Escape') cancelEdit() }}
                        style={{
                          flex: 1,
                          padding: '5px 10px',
                          fontSize: '14px',
                      ...
                      <button
                        ...
                        style={{ padding: '5px 12px', fontSize: '13px', fontWeight: 600, borderRadius: '6px', border: '1px solid var(--accent)', background: 'var(--accent)', color: '#fff', cursor: 'pointer' }}
                      >
                        {t("saveChanges")}
                      </button>
                      <button
                        onClick={cancelEdit}
                        style={{ padding: '5px 12px', fontSize: '13px', fontWeight: 500, borderRadius: '6px', border: '1px solid var(--border)', background: 'transparent', color: 'var(--text)', cursor: 'pointer' }}
                      >
                        {t("cancel")}
                      </button>
                    </div>
                    {editError && <span style={{ fontSize: '12px', color: 'var(--danger)' }}>{editError}</span>}
                  </div>
                ) : (
                  <>
                    <span style={{ color: 'var(--text-h)', fontSize: '14px', fontWeight: 500, flex: 1 }}>
                      {p.name}
                    </span>
                    {confirmDelete === p.name ? (
                      <div style={{ display: 'flex', gap: '8px' }}>
                        ...
                        <button
                          ...
                          style={{ color: 'var(--danger)', background: 'var(--danger-bg)', border: '1px solid var(--danger-border)', borderRadius: '6px', padding: '5px 12px', fontSize: '13px', cursor: 'pointer', fontWeight: 500 }}
