      ...
      >
        ...
        >
          ...
          <p style={{ color: 'var(--text-2)', fontSize: '18px', marginBottom: '32px' }}>
            Hello, <strong>{currentUser}</strong>! You have successfully authenticated using your
            face.
          </p>
          ...
          >
            ...
            <p style={{ color: 'var(--text-2)', fontSize: '14px', margin: 0 }}>
              This information is only visible to users who have completed the face recognition
              scan. Your biometric profile is stored locally and used for secure access.
            </p>
          </div>
        </div>
      </main>
